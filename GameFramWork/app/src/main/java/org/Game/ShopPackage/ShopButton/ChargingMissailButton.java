...
public class ChargingMissailButton extends GraphicObject implements I_Button {
    public ChargingMissailButton(Bitmap m_bitmap, int _x, int _y) {
        super(m_bitmap);
        setPosition(_x,_y);
    }
    ...
    public void Draw(Canvas canvas) {
        ...
        canvas.drawText("Charging Missile",this.getM_x()+this.getM_bitmap().getWidth()/4,this.getM_y()+this.getM_bitmap().getHeight()-paint.getTextSize()/2,paint);
    }
    @Override
    public void method() {
